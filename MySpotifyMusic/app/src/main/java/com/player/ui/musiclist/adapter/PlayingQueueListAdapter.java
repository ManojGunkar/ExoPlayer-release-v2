...
import com.player.ui.widgets.RoundedTransformation;
...
import static com.player.utils.ImageConverter.getRoundedCornerBitmap;
import static com.player.utils.Utils.dpToPx;
import static com.player.utils.Utils.getBitmapOfVector;
import static com.player.utils.Utils.getUriToResource;
            ...
            public void onClick(View v) {
                switch (queueType){
                    case History:
                        ...
                        break;
                    case Playing:
                        App.getPlayingQueueHandler().getPlayingQueue().resetPlaying();
                        break;
                    case Manual_UpNext:
                        App.getPlayingQueueHandler().getPlayingQueue().addListItemToPlaying(queueType, itemPosition);
                        break;
