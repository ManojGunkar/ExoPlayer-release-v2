...
import static com.player.ui.musiclist.activity.Surround3DActivity.EFFECT_POWER_OFF;
import static com.player.ui.musiclist.activity.Surround3DActivity.EFFECT_POWER_ON;
import static com.player.ui.musiclist.activity.Surround3DActivity.EQUALIZER_POSITION;
import static com.player.ui.musiclist.activity.Surround3DActivity.equalizer.off;
import static com.player.ui.musiclist.activity.Surround3DActivity.equalizer.on;
...
public class EqualizerViewAdapter extends RecyclerView.Adapter<EqualizerViewAdapter.SimpleItemViewHolder> {
    ...
    ArrayList<Surround3DActivity.equalizer> selection;
    SharedPreferences pref;
    SharedPreferences.Editor editor;

    public EqualizerViewAdapter(Surround3DActivity surround3DActivity, List<String> eq_names, TypedArray eq_active_on, TypedArray eq_active_off, TypedArray eq_inactive_on, TypedArray eq_inactive_off) {
        ...
        int pos = pref.getInt("equalizer_position", EQUALIZER_POSITION);
    ...
    public void onBindViewHolder(final SimpleItemViewHolder holder, final int position) {
        ...
        holder.eqImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                editor = pref.edit();
                editor.putInt("equalizer_position", position);
                editor.commit();
                selection.clear();
                for (int i=0; i<eq_active_on.length();i++){
                    if(i==position){
