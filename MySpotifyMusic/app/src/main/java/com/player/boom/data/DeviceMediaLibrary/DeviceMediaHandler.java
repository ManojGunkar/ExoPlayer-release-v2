package com.player.boom.data.DeviceMediaLibrary;
...
//                Check whether Collection contains it's item list.
                ...
                }else if(((MediaItemCollection) collection).getMediaElement().get(((MediaItemCollection) collection).getCurrentIndex()).getItemType() == ItemType.ALBUM) {
    ...
    public ArrayList<? extends IMediaItemBase> QueryMediaCollectionForQueue(IMediaItemBase collection, @IntRange(from=-1) int position){
        ...
        if(collection.getItemType() == ItemType.ALBUM && ((MediaItemCollection)collection).getMediaElement().size()==0){
            ...
            }else if(((MediaItemCollection)collection).getMediaElement().get(position).getItemType() == ItemType.ALBUM){
