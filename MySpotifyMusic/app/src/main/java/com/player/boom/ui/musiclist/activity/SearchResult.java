...
import com.player.boom.ui.musiclist.fragment.SearchResultFragment;
...
public class SearchResult extends BoomMasterActivity {
    ...
    private void initView() {
        mTabBar= (MusicTabBar) findViewById(R.id.search_result_tab_bar);
    ...
    private void setCustomTab(){
        int[] res=new int[]{R.drawable.ic_account_balance_white_24dp,
                ...
                R.drawable.ic_alarm_add_white_24dp};
        int[] select_res=new int[]{R.drawable.ic_account_balance_white_24dp,
                R.drawable.ic_account_box_white_24dp,
                R.drawable.ic_event_white_24dp,
                R.drawable.ic_alarm_add_white_24dp ,
                R.drawable.ic_alarm_add_white_24dp};
        MusicTabLayout customTabLayout=new MusicTabLayout(res, select_res);
