...
public final class AudioTrack {
  ...
  public AudioTrack(AudioCapabilities audioCapabilities, AudioProcessor[] audioProcessors,
    ...
    availableAudioProcessors = new AudioProcessor[2 + audioProcessors.length];
    ...
    //[2 + audioProcessors.length] = sonicAudioProcessor;
  ...
  public void configure(String mimeType, int channelCount, int sampleRate,
    ...
    if ( encoding == C.ENCODING_PCM_FLOAT ) {
      ...
      outputPcmFrameSize = Util.getPcmFrameSize(C.ENCODING_PCM_FLOAT, channelCount);
    }
