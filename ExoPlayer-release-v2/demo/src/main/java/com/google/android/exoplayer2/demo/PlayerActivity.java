...
public class PlayerActivity extends Activity implements OnClickListener, ExoPlayer.EventListener,
  ...
  private Switch fullBassSwitch;
  private SeekBar intensitySeekbar;

  private void showEffectsDialog() {

    View effectView = getLayoutInflater().inflate(R.layout.effects, null);

    effectsSwitch = (Switch)effectView.findViewById(R.id.effect_switch);
    ...
    surroundSwitch = (Switch) effectView.findViewById(R.id.surround_switch);
    ...
    fullBassSwitch = (Switch)effectView.findViewById(R.id.fullbass_switch);
    ...
    intensitySeekbar = (SeekBar) effectView.findViewById(R.id.intensity_seekbar);
    ...
    builder.setTitle(R.string.effects);
    builder.setView(effectView);
    builder.show();
  }

  private void updateEffectsView() {
    effectsSwitch.setChecked(mBoomAudioProcessor.getEffectState());

    surroundSwitch.setEnabled(mBoomAudioProcessor.getEffectState());
    fullBassSwitch.setEnabled(mBoomAudioProcessor.getEffectState() && mBoomAudioProcessor.get3DAudioState());
    intensitySeekbar.setEnabled(mBoomAudioProcessor.getEffectState());

    surroundSwitch.setChecked(mBoomAudioProcessor.get3DAudioState());
    fullBassSwitch.setChecked(mBoomAudioProcessor.getFullBassState());
    intensitySeekbar.setProgress((int)(mBoomAudioProcessor.getIntensity() * 10 + 10));
  }
}
