...
import com.player.boom.handler.PlayingQueue.QueueEvent;
import com.player.boom.task.NotificationHandler;
import com.player.boom.task.PlayerService;

import static com.player.boom.handler.PlayerEventHandler.PlayState.play;
...
//                });
    ...
    public long getCurrentPosition() {
        return mPlayer.getSeekPosition();
    }
