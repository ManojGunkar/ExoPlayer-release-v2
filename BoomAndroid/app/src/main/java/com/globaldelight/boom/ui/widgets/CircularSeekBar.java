...
/**
 * Created by Rahul Kumar Agrawal on 01-Jun-2016.
 */
...
public class CircularSeekBar extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            mMax = a.getInteger(R.styleable.CircularSeekBar_maximum, mMax);
            mProgress = a.getInteger(R.styleable.CircularSeekBar_progresses, mProgress);
