 ...
 */
public class TidalPlaylistTrackAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TidalPlaylistTrackAdapter(Context context, List<PlaylistResponse.Items> items, String headerTitle) {
